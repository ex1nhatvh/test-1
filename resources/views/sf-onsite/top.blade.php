...
<div style="width: 70%; margin: 0 auto;">
    @if($draft_id)
    <a href="{{$routeUri}}/property/{{ $property_id }}/room/{{ $room_id }}/result/{{ $draft_id }}" class="btn btn-lg btn-light btn-default btn-block">棚卸作業の続き/Continue Inventory Counting</a>
    @else
