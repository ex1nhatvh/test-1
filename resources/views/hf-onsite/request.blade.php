...
<div class="box-body table-responsive no-padding">
    <table class="table">
        <tbody>
            ...
            <tr>
                <td style="width: 50%;">
                    <div style="line-height:3rem;"><b>{{ $unrequested->created_at->format('Y年m月d日') }}開始/Start</b></div>
                </td>
                <td style="width: 50%;">
                    <div>
                        ...
                        <a href="{{ $routeUri }}/property/{{ $unrequested_new->getValue("Hardfurniture_Inventory_target")->getValue("PropertyColumn_hard")->id }}/room/{{ $unrequested_new->getValue("Hardfurniture_Inventory_target")->getValue("Room_Numbe_hard")->id }}/result/{{ $unrequested_new->getValue("Hardfurniture_Inventory_target")->id }}/i/{{ $unrequested_new->id }}" class="btn btn-primary">続き/continuation</a>
                    </div>
                </td>
            </tr>
            @endif
            ...
            <tr>
                <td style="width: 50%;">
                    <div style="line-height:3rem;"><b>{{ \Carbon\Carbon::parse($item)->format('Y年m月d日') }}申請/Apply</b></div>
                </td>
                <td style="width: 50%;">
                    <div>
